...
function(add_external_project EXTERNAL_NAME)
    ...
    if(CMAKE_GENERATOR_IS_MULTI_CONFIG)
        ...
        if(CMAKE_CROSSCOMPILING)
            list(APPEND EXTERNAL_DEPEND_PROGRAM_PATH "${CMAKE_CURRENT_BINARY_DIR}/../${CMAKE_HOST_SYSTEM_PROCESSOR}/${EXTERNAL_NAME}-release/bin")
        endif()
    else()
        ...
        if(CMAKE_CROSSCOMPILING)
            list(APPEND EXTERNAL_DEPEND_PROGRAM_PATH "${CMAKE_CURRENT_BINARY_DIR}/../${CMAKE_HOST_SYSTEM_PROCESSOR}/${EXTERNAL_NAME}/bin")
        endif()
    endif()
